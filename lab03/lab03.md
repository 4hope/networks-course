...
#### Демонстрация работы
<img src="images/Aok.png" width=500 />
<img src="images/A!ok.png" width=500 />
...
#### Демонстрация работы
<img src="images/Cok&!ok.png" width=500 />
...
Размер одного пакета: 56 байт = 448 бит
t1 = 448 / 128000 = 0.0035 c = 3.5 мс - время сборки пакета хостом А
t2 = 448 / 1000000 = 0.000448 c = 0.448 мс - время передачи от A до В
t3 = 5 мс - зедержка распространения сигнала
Итого получаем t = t1 + t2 + t3 = 3.5 + 0.448 + 5 = 8.948 мс
...
#### Решение
В буфере в среднем 10 пакетов, плюс 1 пакет передаётся в данный момент, значит: N = 10 + 1 = 11
t1 = 1 / 100 = 0.01 с = 10 мс - время передачи одного пакета
t2 = 10 мс - средняя задержка ожидания
d = t1 + t2 = 10 + 10 = 20 мс = 0.02 с - полная задержка
По формуле Литтла: N = a * d
Тогда: a = N / d = 11 / 0.02 = 550 пакетов/с
